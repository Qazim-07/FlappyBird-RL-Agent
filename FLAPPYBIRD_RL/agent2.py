...
class Agent:
    ...
    def run(self, is_training=True, render=False):
        ...
        for episode in itertools.count():  
            ...
            while (not terminated and episode_reward < self.reward_threshold):
                ...
                episode_reward += reward.item() # Use .item() to keep python float tracker clean
                ...
                if is_training:
                    ...
                    if len(memory) > self.mini_batch_size:
                        ...
                        self.optimize_batch(mini_batch, policy_dqn, target_dqn)
            ...
            print(f"for episode = {episode+1} with total reward = {episode_reward} & epsilon = {epsilon:.4f}")
    ...
    def optimize_batch(self, mini_batch, policy_dqn, target_dqn):
...
if __name__ == "__main__":
    ...
    parser.add_argument('hyperparameters', help='Name of hyperparameter set in yaml config')
